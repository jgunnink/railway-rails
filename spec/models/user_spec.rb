...
RSpec.describe User do
  ...
  describe '.ransack' do
    describe '.full_name' do
      subject { User.ransack({full_name_cont: "JK Gunnink"}).result }

      it { should include(FactoryGirl.create(:user, given_names: "JK", family_name: "Gunnink")) }
      it { should include(FactoryGirl.create(:user, given_names: "JK", family_name: "GUNNINK")) }

      it { should_not include(FactoryGirl.create(:user, given_names: "JK", family_name: "Tuesday")) }
      it { should_not include(FactoryGirl.create(:user, given_names: "Tuesday", family_name: "Gunnink")) }
    end
  end
